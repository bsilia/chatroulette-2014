...
function Rulette(){
	...
	this.socketURL = 'http://192.168.137.37:1986'+this.namespace; 
...
Rulette.prototype.onConnect = function () {
	...
	client.setStatusBox('Caro '+client.nickname+', vous êtes connecté à la websocket!, à la recherche du personne ...');
	//set nickname
